...
export const Amenidades = () => {
  ...
  return (
    <section className="amenidades overflow-hidden pt-[90px] lg:flex gap-8 justify-center w-[90%] mx-auto max-w-[1366px]">
      <div className="lg:w-[35%] text-[#2e2e2e]" data-aos="zoom-in">
        <p className="text-xl tracking-wider">Conoce Nuestras</p>
        <h1 className="text-3xl lg:text-4xl font-semibold tracking-widest ">
          Amenidades
        </h1>
        <div className="pt-5 ps-3 [&>p]:flex [&>p]:h-[40px] [&>p]:items-center [&>p]:mb-[7px] [&>p]:lg:text-xl [&>p]:font-semibold [&>p]:tracking-wider [&>p]:cursor-pointer" data-aos="fade-left">
      ...
      <div className="lg:w-[65%] lg:h-[600px] mt-[80px] lg:mt-[7%]" data-aos="fade-left">
        <Carousel index={index} setIndex={setIndex}>
          {[
            ...carousel_data.map((s, i) => (
              <img src={s.url} key={i} className="lg:h-[550px]" />
            )),
          ]}
        </Carousel>
      </div>
