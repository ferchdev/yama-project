  ...
  return (
    <section className="amenidades overflow-hidden pt-[130px] lg:flex gap-8 justify-center w-[90%] mx-auto max-w-[1366px]">
      <div className="lg:w-[35%] text-[#2e2e2e]">
        ...
        <div
          className="pt-5 ps-3 [&>p]:flex [&>p]:h-[40px] [&>p]:items-center [&>p]:mb-[7px] [&>p]:lg:text-xl [&>p]:font-semibold [&>p]:tracking-wider [&>p]:cursor-pointer"
          data-aos="fade-up"
      ...
      <div
        className="lg:w-[60%] lg:h-[600px] mt-[80px] lg:mt-[7%]"
        data-aos="fade-up"
        data-aos-duration="500"
      >
